...
#problem[
  ...
  + Given the $k$-linear map $mu:P_(e-1) plus.circle P_(d-1) arrow.r P_(d+e-1)$ in part (a), choose the standard basis ${1,x,...,x^(e-1)}$ for $P_(e-1)$, and ${1,x,...,x^(d-1)}$ for $P_(d-1)$, the standard basis for $P_(e-1) plus.circle P_(d-1)$ is given by ${(1,0),(x,0),...,(x^(e-1),0),(0,1),(0,x),...,(0,x^(d-1))}$. 
    ...
    Hence, by statement in part (a), $f,g$ have common roots $<==>$ $mu$ has non-trivial kernel, which the latter statement is equivalent to the above determinant being $0$. Hence, $f,g$ have common roots, iff $Res(f,g)=0$.
...
#problem[
  ...
  + Show that $I(overline(Y))$ is the ideal generated by $beta(I(Y))$, all the homogeneous polynomials contained in $I(Y)$.
