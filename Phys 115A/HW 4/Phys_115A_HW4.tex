...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \end{align}
        Let $c:=\frac{1}{4a^2}-i\frac{\hbar t}{2m} = \frac{m-i\hbar 2a^2t}{4ma^2}$, $d:= -ix$, then with the substitution $u=\sqrt{c}(k+d/(2c))$ ($du = \sqrt{c}dk$), $ck^2+dk = u^2 - d^2/(4c)$, hence the integral (with exponent $-ck^2 - dk$) becomes as follow:
        \begin{align}
            \frac{1}{2a\sqrt{\pi}}\left(\frac{2a^2}{\pi}\right)^\frac{1}{4}\frac{1}{\sqrt{c}}\int_{-\sqrt{c}\infty}^{\sqrt{c}\infty}e^{-u^2}e^{d^2/(4c)}du = \frac{1}{2a\sqrt{c}}\left(\frac{2a^2}{\pi}\right)^\frac{1}{4}e^{d^2/(4c)}
        \end{align}
        With $\frac{d^2}{4c}=\frac{-4ma^2x^2}{m-i\hbar 2a^2t}$, the solution becomes as follow:
        \begin{align}
            \Psi(x,t)=\frac{1}{2a}\left(\frac{2a^2}{\pi}\right)^\frac{1}{4}\sqrt{\frac{4ma^2}{m-i\hbar 2a^2t}}\exp\left(\frac{-4ma^2 x^2}{m-i\hbar 2a^2t}\right)
        \end{align}
