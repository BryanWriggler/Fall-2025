...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item[2.] If express $\Psi(x,0)=\frac{1}{\sqrt{2\pi}}\int_{-\infty}^{\infty}\phi(k)e^{ikx}dk$, then by Inverse Fourier Transform one has $\phi(k)=\frac{1}{\sqrt{2\pi}}\int_{-\infty}^{\infty}\Psi(x,0)e^{-ikx}dx = \frac{A}{\sqrt{2\pi}}\int_{-\infty}^{\infty}e^{-a^2x^2-ikx}dx$.
    \end{itemize}
\end{proof}
