...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \begin{align}
            ...
            &= \frac{A}{\lambda^2}\left(-\frac{1}{2}u^2e^{-u^2}\bigg|_{-\infty}^{\infty}+\int_{-\infty}^{\infty}ue^{-u^2}du\right)+\frac{3}{2\lambda}+\mu^3-3\mu^2+\mu^3 A\sqrt{\frac{\pi}{\lambda}}\\
            &= \frac{A}{\lambda^2}\left(-\frac{1}{2}e^{-u^2}\bigg|_{-\infty}^{\infty}\right)+\frac{3}{2\lambda}+\mu^3-3\mu^2+\mu^3 \cdot\sqrt{\frac{\lambda}{\pi \mu^2}}\sqrt{\frac{\pi}{\lambda}}\\
            &= \frac{3}{2\lambda}+\mu^3-2\mu^2
        \end{align}
        With the above equations, we get $\sigma=\sqrt{\left<x^2\right>-\left<x\right>^2} = \sqrt{\frac{3}{2\lambda}-\frac{1}{2\mu\lambda}+\mu^3-3\mu^2}$. And, here is a sketch of $\rho(x)$:

        \textbf{insert image}

        Overall, even though $\rho(x)$ is normalizable, the reason why $\rho(x)$ is not a probability density function, is because it yields negative values for $x<0$.
