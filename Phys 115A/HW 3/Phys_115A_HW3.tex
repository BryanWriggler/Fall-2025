...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \begin{align}
            ...
            &= \int_{-\infty}^{\infty}\sqrt{\frac{2mw}{\hbar}}\left(\frac{mw}{\pi\hbar}\right)^\frac{1}{4}xe^{-\frac{mw}{2\hbar}x^2}\cdot \left(\frac{2mw}{\hbar}\left(\frac{mw}{\pi\hbar}\right)^\frac{1}{4}x^2e^{-\frac{mw}{2\hbar}x^2} - \left(\frac{mw}{\pi\hbar}\right)^\frac{1}{4}e^{-\frac{mw}{2\hbar}x^2}\right)dx\\
        ...
        \begin{align}
            \int_{-\infty}^{\infty}(\psi_0(x))^*((a_+)^2\psi_0(x))dx = \int_{-\infty}^{\infty}
        \end{align}
